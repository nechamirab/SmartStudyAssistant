...
TRANSLATIONS = {
    "en": {
        ...
        "prompt_recursion": "Explain recursion with an example",
        "prompt_algorithms_exam": "Help me prepare for an algorithms exam",
        "prompt_big_o": "Explain Big O notation simply",
        "prompt_practice_questions": "Create practice questions",
    ...
    "he": {
        ...
        "prompt_recursion": "הסבר רקורסיה עם דוגמה",
        "prompt_algorithms_exam": "עזור לי להתכונן למבחן באלגוריתמים",
        "prompt_big_o": "הסבר Big O בפשטות",
        "prompt_practice_questions": "צור שאלות תרגול",
